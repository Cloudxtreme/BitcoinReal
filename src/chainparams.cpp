...
// Copyright (c) 2017-2018 The BTCr Core developers
...
{
    const char* pszTimestamp = "23/7/2018 - The BitcoinReal revolution begins.";
    const CScript genesisOutputScript = CScript() << ParseHex("0416b228b51e7a09395e74045011e480869e18ae574ec7304ad01e782f8f5a567612dae2bb22feed15034b9030c9776d068f250301fa5ae3a774eaaa080a35f548") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 999999999999999; // Disabled
        ...
        consensus.nPowTargetTimespan = 0.2 * 60; // BTCr: 12 seconds
        consensus.nPowTargetSpacing = 0.1 * 60; // BTCr: 6 seconds
        ...
        vAlertPubKey = ParseHex("0452755789b8792a5ca53ea7e6a9e66b7d9222bd8eeb314250ad7c42cfe0606310e492c30faf4402e5597f17ed5009bf1d1ec27e6c5023a80dfbeb08ef8179bd62");
        nDefaultPort = 61472;
        nMaxTipAge = 6 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in btcr
        nDelayGetHeadersTime = 24 * 60 * 60;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1532634000, 861742, 504365040, 1, 50 * COIN);
   ...
   /*
     ...
     */
        assert(consensus.hashGenesisBlock == uint256S("0000028bd7389dbbb48cf044ef92d896d58024a82ac5ea5fe956c0908dd5f62d"));
        assert(genesis.hashMerkleRoot == uint256S("17ccf6106468199a2e45bd2ae9399a73594e6e3eb52a6baa99e1a9debfd56fc7"));

        //vSeeds.push_back(CDNSSeedData("35.177.197.93", "35.177.197.93"));
        //vSeeds.push_back(CDNSSeedData("35.176.165.237", "35.176.165.237"));
        vFixedSeeds = std::vector<SeedSpec6>(pnSeed6_main, pnSeed6_main + ARRAYLEN(pnSeed6_main));
        vSeeds.clear();

        // BTCr addresses start with 'B'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,10);
        // BTCr script addresses start with '8'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,18);
        // BTCr private keys start with 't'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128+63);
        // BTCr BIP32 pubkeys start with 'xpub' (BTCr defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // BTCr BIP32 prvkeys start with 'xprv' (BTCr defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // BTCr BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        strSporkPubKey = "04da03f2d97bc8d1cbe11a431be025c3c79e437af9e3a2ddc81234d3530d6478aa5b34ef591674444922ef6cb9882006e27dc7e7da02b268552117fa";

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0000040eae5347970908208b392a5b09e9053ad4a6c25ced7b5402d399d9671f"))
            (  15, uint256S("00000af7cff828e1317a8958793c56eefe5e169dce4cd60e355ed0709a69c7e9"))
            (  16, uint256S("0000052d1f2c9f93063b254ad9fa847d106dfcf54944dcf665986b1f7d53827e")),
            1537120689, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 30 * 60 * 2; // BTCr: 1 hour
        consensus.nPowTargetSpacing = 2 * 60; // BTCr: 2 minutes
       ...
       // assert(consensus.hashGenesisBlock == uint256S("0x00000ba049e5c1f95474ea3fc62d5f1b1632a294c20c22fea701134a43cf3068"));
        ...
        vSeeds.push_back(CDNSSeedData("testnet.btcrproject.org", "testnet.seed.btcrproject.org"));
        vSeeds.push_back(CDNSSeedData("fixed-seeds.btcrproject.org", "testnet.fixed-seeds.btcrproject.org"));
        // vFixedSeeds.clear();
        // vSeeds.clear();

        // Testnet BTCr addresses start with 'm'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,110);
        // Testnet BTCr script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,21);
        // Testnet private keys start with '9' or 'c' (BTCr defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet BTCr BIP32 pubkeys start with 'tpub' (BTCr defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet BTCr BIP32 prvkeys start with 'tprv' (BTCr defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet BTCr BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
       ...
       // assert(consensus.hashGenesisBlock == uint256S("0x000005ec6d48ac579d697448a82e93127b94403770629399cf561caa216a694b"));
        ...
        // Regtest BTCr addresses start with 'o'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,115);
        // Regtest BTCr script addresses start with 'a'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,83);
        // Regtest private keys start with '9' or 'c' (BTCr defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest BTCr BIP32 pubkeys start with 'tpub' (BTCr defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest BTCr BIP32 prvkeys start with 'tprv' (BTCr defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest BTCr BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
